...
function BuilderPage() {
    ...
    const form = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$forms$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFormsStore"])({
        "BuilderPage.useFormsStore[form]": (state)=>state.forms.find({
                "BuilderPage.useFormsStore[form]": (f)=>f.id === id
            }["BuilderPage.useFormsStore[form]"])
    }["BuilderPage.useFormsStore[form]"]);
    const updateForm = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$forms$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFormsStore"])({
        "BuilderPage.useFormsStore[updateForm]": (state)=>state.updateForm
    }["BuilderPage.useFormsStore[updateForm]"]);
    // --- State ---
    ...
    const handleDragEnd = (event)=>{
        ...
        if (activeSectionIndex !== -1) {
            ...
            if (overSectionIndex !== -1) setSections((prev)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$sortable$2f$dist$2f$sortable$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["arrayMove"])(prev, activeSectionIndex, overSectionIndex));
            return;
        }
...
_s(BuilderPage, "JEdSNfYvtTPGI6J8RYumQWPeC18=", false, function() {
    return [
...
//# sourceMappingURL=_b08ec0d8._.js.map